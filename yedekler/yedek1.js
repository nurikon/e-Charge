  ...
  sendData=()=>{
    ...
    window.Blob = Blob
      ...
      return new Promise((resolve, reject) => {
        const uploadUri =uri
          let uploadBlob = null
          const imageRef = firebase.storage().ref('posts').child(stationId)
          ...
          <View  style={{ height:120}}>
            <ScrollView horizontal style={imageScrollView}>
              ...
              <View style={imageContainer}> 
                <Image style={{flex:1}} source={{uri:this.state.images}}/>
              </View>
            
              <TouchableOpacity 
                style={[{justifyContent: 'center', alignItems:'center',}, imageContainer ]} 
                onPress={()=> this.imgPickerCamera()}
                >
    ...
    uri.forEach((element, index )=> {
      ...
      uploadImage = () => {
        return new Promise((resolve, reject) => {
            ...
            let uploadBlob = null
            const imageRef = firebase.storage().ref(stationId).child(index)
